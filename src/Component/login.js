...
export default class Login extends Component 
{
    ...
    validateToken()
    {
        axios.post('http://localhost:3001/token/validation', {"localtoken":localStorage.getItem('authToken')}, {withCredentials: true, validateStatus: function (status) { return status >= 200 && status < 600; 
        }}).then( res =>{
